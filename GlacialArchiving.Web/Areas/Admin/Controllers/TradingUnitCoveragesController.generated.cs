...
{   
    /// <summary>
    ///     The definition of TradingUnitCoveragesController
    /// </summary>
    public partial class TradingUnitCoveragesController : SecureController
    {
        /// <summary>
        ///     Default constructor for TradingUnitCoveragesController
        /// </summary>
        public TradingUnitCoveragesController() 
        { 
        ...
        partial void BeforeValidate(TradingUnitCoverage obj);
        partial void BeforeCreate(TradingUnitCoverage obj);
        partial void AfterCreate(TradingUnitCoverage obj);
        partial void BeforeEdit(TradingUnitCoverage oldObj, TradingUnitCoverage obj);
        partial void AfterEdit(TradingUnitCoverage obj);
        ...
        /// <summary>
        ///     Sends the user to the listing page for TradingUnitCoverages
        /// </summary>
        ...
        public ActionResult Index(LoggedInUser currentUser)
        {
            ...
            ViewResult result = View(work.TradingUnitCoverageRepository.AllIncluding(obj => obj.UploadedItem, obj => obj.CreatedBy, obj => obj.ModifiedBy));
            this.log.Info("Index", "View created and returning");
            return result;
        }   // GET: /Admin/TradingUnitCoverages/
        #endregion
        #region Section 'Actions - Create'
        /// <summary>
        ///     View to create a new TradingUnitCoverage in the system
        /// </summary>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        public ActionResult Create(LoggedInUser currentUser)
        {
            ...
            return result;
        }   // GET: /Admin/TradingUnitCoverages/Create
        /// <summary>
        ///     Submission of a TradingUnitCoverage from the UI
        /// </summary>
        /// <param name="obj">The new object to insert into the database</param>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        [HttpPost]
        public ActionResult Create(TradingUnitCoverage obj, LoggedInUser currentUser)
        {
            this.log.Info("Create [POST]", "Start of function");
            if (obj.Id == 0)
                ModelState["TradingUnitCoverageId"].Errors.Clear();
                
            this.BeforeValidate(obj);
            if (ModelState.IsValid) 
            {
                this.BeforeCreate(obj);
                work.TradingUnitCoverageRepository.InsertOrUpdate(obj, currentUser.User);
                work.Save();
        ...
        }  // POST: /Admin/TradingUnitCoverages/Create
        #endregion
        #region Section 'Actions - Edit'
        /// <summary>
        ///     View to edit an existing TradingUnitCoverage record in the system
        /// </summary>
        ...
        public ActionResult Edit(int id, LoggedInUser currentUser)
        {
            ...
            ViewResult result = View(work.TradingUnitCoverageRepository.Find(id));
            this.log.Info("Edit", "View created and returning");
            return result;
        }  // GET: /Admin/TradingUnitCoverages/Edit/{id}
        /// <summary>
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Edit(TradingUnitCoverage obj, LoggedInUser currentUser)
        {
            ...
            if (ModelState.IsValid) 
            {
                TradingUnitCoverage oldObj = work.TradingUnitCoverageRepository.Find(obj.Id);
                obj.SyncExcludedFields(oldObj);
            
                this.BeforeEdit(oldObj, obj);
                work.TradingUnitCoverageRepository.InsertOrUpdate(obj, currentUser.User);
                work.Save();
                obj = work.TradingUnitCoverageRepository.Find(obj.Id); //need to rehydrate the FKs
                this.AfterEdit(obj);
        ...
        }  // POST: /Admin/TradingUnitCoverages/Edit/{id}
        #endregion
        ...
        public ActionResult Delete(int id, LoggedInUser currentUser)
        {
            ...
            return result;
        }  // GET: /Admin/TradingUnitCoverages/Delete/5
        /// <summary>
        ...
        public ActionResult DeleteConfirmed(int id, LoggedInUser currentUser)
        {
            ...
            TradingUnitCoverage obj = work.TradingUnitCoverageRepository.Find(id);
            obj.IsDeleted = true;
            work.Save();
            this.AfterDelete(id);
            this.log.Info("Delete [POST]", "Object has been deleted");
            return RedirectToAction("Index");
        }  // POST: /Admin/TradingUnitCoverages/Delete/{id}
        #endregion
        #region Section 'Actions - Inline'
        /// <summary>
        ///     Retrieve view to create/edit an existing TradingUnitCoverage record in the system
        /// </summary>
        /// <param name="id">The id of the record to edit</param>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        public ActionResult QueryItem(int id, LoggedInUser currentUser)
        {
            ...
            TradingUnitCoverage obj = null;
            if (id != 0)
                obj = work.TradingUnitCoverageRepository.Find(id);

            ViewResult result = View("_CreateOrEdit", obj);
            this.log.Info("QueryItem", "View created and returning");
            return result;
        }  // GET: /Admin/TradingUnitCoverages/QueryItem/{id}
        /// <summary>
        ///     Submission of the editing model back from the UI
        /// </summary>
        /// <param name="obj">The edited model</param>
        ...
        /// <returns></returns>
        [HttpPost]
        public MvcHtmlString InsertOrUpdate(TradingUnitCoverage obj, LoggedInUser currentUser)
        {
            this.log.Info("Edit [POST]", "Start of function");
            if (obj.Id == 0)
                ModelState["TradingUnitCoverageId"].Errors.Clear();
        ...
        {
            this.log.Info("Delete", "Start of function");
            ViewResult result = View("_Display", work.TradingUnitCoverageRepository.Find(id));
            this.log.Info("Delete", "View created and returning");
            return result;
        ...
        /// <summary>
        ///     Filters the listing down to only show specific TradingUnitCoverage records based on the id provided for the UploadedItem record to look for
        /// </summary>
        ...
        public ActionResult UploadedItem(int id, LoggedInUser currentUser)
        {
            ...
            ViewResult result = View("Index", item.TradingUnitCoverages);
            this.log.Info("UploadedItem", "View created and returning");
            return result;
        }  // GET: /Admin/TradingUnitCoverages/UploadedItem/{id}
		
        /// <summary>
        ///     Filters the listing down to only show specific TradingUnitCoverage records based on the id provided for the Customer record to look for
        /// </summary>
        ...
        public ActionResult UploadedItemInline(int id, LoggedInUser currentUser)
        {
            ...
            var item = work.UploadedItemRepository.Find(id);
            ViewResult result = View("_List", item.TradingUnitCoverages);
            this.log.Info("UploadedItemInline", "View created and returning");
            return result;
        }  // GET: /Admin/TradingUnitCoverages/UploadedItemInline/{id}
        #endregion
