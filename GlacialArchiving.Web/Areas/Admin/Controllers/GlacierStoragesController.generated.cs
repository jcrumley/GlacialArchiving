...
{   
    /// <summary>
    ///     The definition of GlacierStoragesController
    /// </summary>
    public partial class GlacierStoragesController : SecureController
    {
        /// <summary>
        ///     Default constructor for GlacierStoragesController
        /// </summary>
        public GlacierStoragesController() 
        { 
        ...
        partial void BeforeValidate(GlacierStorage obj);
        partial void BeforeCreate(GlacierStorage obj);
        partial void AfterCreate(GlacierStorage obj);
        partial void BeforeEdit(GlacierStorage oldObj, GlacierStorage obj);
        partial void AfterEdit(GlacierStorage obj);
        ...
        /// <summary>
        ///     Sends the user to the listing page for GlacierStorages
        /// </summary>
        ...
        public ActionResult Index(LoggedInUser currentUser)
        {
            ...
            ViewResult result = View(work.GlacierStorageRepository.AllIncluding(obj => obj.UploadedItem, obj => obj.CreatedBy, obj => obj.ModifiedBy));
            this.log.Info("Index", "View created and returning");
            return result;
        }   // GET: /Admin/GlacierStorages/
        #endregion
        #region Section 'Actions - Create'
        /// <summary>
        ///     View to create a new GlacierStorage in the system
        /// </summary>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        public ActionResult Create(LoggedInUser currentUser)
        {
            ...
            return result;
        }   // GET: /Admin/GlacierStorages/Create
        /// <summary>
        ///     Submission of a GlacierStorage from the UI
        /// </summary>
        /// <param name="obj">The new object to insert into the database</param>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        [HttpPost]
        public ActionResult Create(GlacierStorage obj, LoggedInUser currentUser)
        {
            this.log.Info("Create [POST]", "Start of function");
            if (obj.Id == 0)
                ModelState["GlacierStorageId"].Errors.Clear();
                
            this.BeforeValidate(obj);
            if (ModelState.IsValid) 
            {
                this.BeforeCreate(obj);
                work.GlacierStorageRepository.InsertOrUpdate(obj, currentUser.User);
                work.Save();
        ...
        }  // POST: /Admin/GlacierStorages/Create
        #endregion
        #region Section 'Actions - Edit'
        /// <summary>
        ///     View to edit an existing GlacierStorage record in the system
        /// </summary>
        ...
        public ActionResult Edit(int id, LoggedInUser currentUser)
        {
            ...
            ViewResult result = View(work.GlacierStorageRepository.Find(id));
            this.log.Info("Edit", "View created and returning");
            return result;
        }  // GET: /Admin/GlacierStorages/Edit/{id}
        /// <summary>
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Edit(GlacierStorage obj, LoggedInUser currentUser)
        {
            ...
            if (ModelState.IsValid) 
            {
                GlacierStorage oldObj = work.GlacierStorageRepository.Find(obj.Id);
                obj.SyncExcludedFields(oldObj);
            
                this.BeforeEdit(oldObj, obj);
                work.GlacierStorageRepository.InsertOrUpdate(obj, currentUser.User);
                work.Save();
                obj = work.GlacierStorageRepository.Find(obj.Id); //need to rehydrate the FKs
                this.AfterEdit(obj);
        ...
        }  // POST: /Admin/GlacierStorages/Edit/{id}
        #endregion
        ...
        public ActionResult Delete(int id, LoggedInUser currentUser)
        {
            ...
            return result;
        }  // GET: /Admin/GlacierStorages/Delete/5
        /// <summary>
        ...
        }  // POST: /Admin/GlacierStorages/Delete/{id}
        #endregion
        #region Section 'Actions - Inline'
        /// <summary>
        ///     Retrieve view to create/edit an existing GlacierStorage record in the system
        /// </summary>
        /// <param name="id">The id of the record to edit</param>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        public ActionResult QueryItem(int id, LoggedInUser currentUser)
        {
            ...
            GlacierStorage obj = null;
            if (id != 0)
                obj = work.GlacierStorageRepository.Find(id);

            ViewResult result = View("_CreateOrEdit", obj);
            this.log.Info("QueryItem", "View created and returning");
            return result;
        }  // GET: /Admin/GlacierStorages/QueryItem/{id}
        /// <summary>
        ///     Submission of the editing model back from the UI
        /// </summary>
        /// <param name="obj">The edited model</param>
        ...
        /// <returns></returns>
        [HttpPost]
        public MvcHtmlString InsertOrUpdate(GlacierStorage obj, LoggedInUser currentUser)
        {
            this.log.Info("Edit [POST]", "Start of function");
            if (obj.Id == 0)
                ModelState["GlacierStorageId"].Errors.Clear();
        ...
        {
            this.log.Info("Delete", "Start of function");
            ViewResult result = View("_Display", work.GlacierStorageRepository.Find(id));
            this.log.Info("Delete", "View created and returning");
            return result;
        ...
        /// <summary>
        ///     Filters the listing down to only show specific GlacierStorage records based on the id provided for the UploadedItem record to look for
        /// </summary>
        ...
        public ActionResult UploadedItem(int id, LoggedInUser currentUser)
        {
            ...
            ViewResult result = View("Index", item.GlacierStorages);
            this.log.Info("UploadedItem", "View created and returning");
            return result;
        }  // GET: /Admin/GlacierStorages/UploadedItem/{id}
		
        /// <summary>
        ///     Filters the listing down to only show specific GlacierStorage records based on the id provided for the Customer record to look for
        /// </summary>
        ...
        public ActionResult UploadedItemInline(int id, LoggedInUser currentUser)
        {
            ...
            var item = work.UploadedItemRepository.Find(id);
            ViewResult result = View("_List", item.GlacierStorages);
            this.log.Info("UploadedItemInline", "View created and returning");
            return result;
        }  // GET: /Admin/GlacierStorages/UploadedItemInline/{id}
        #endregion
