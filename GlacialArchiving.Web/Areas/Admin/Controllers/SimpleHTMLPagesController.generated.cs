...
{   
    ...
    /// </summary>
    public partial class SimpleHTMLPagesController : SecureController
    {
        /// <summary>
        ///     Default constructor for SimpleHTMLPagesController
        /// </summary>
        public SimpleHTMLPagesController() 
        { 
        ...
        partial void BeforeValidate(SimpleHTMLPage obj);
        partial void BeforeCreate(SimpleHTMLPage obj);
        partial void AfterCreate(SimpleHTMLPage obj);
        partial void BeforeEdit(SimpleHTMLPage oldObj, SimpleHTMLPage obj);
        partial void AfterEdit(SimpleHTMLPage obj);
        ...
        /// <summary>
        ///     Sends the user to the listing page for SimpleHTMLPages
        /// </summary>
        ...
        public ActionResult Index(LoggedInUser currentUser)
        {
            ...
            ViewResult result = View(work.SimpleHTMLPageRepository.AllIncluding(obj => obj.CreatedBy, obj => obj.ModifiedBy));
            this.log.Info("Index", "View created and returning");
            return result;
        }   // GET: /Admin/SimpleHTMLPages/
        #endregion
        #region Section 'Actions - Create'
        /// <summary>
        ///     View to create a new SimpleHTMLPage in the system
        /// </summary>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        public ActionResult Create(LoggedInUser currentUser)
        {
            ...
            return result;
        }   // GET: /Admin/SimpleHTMLPages/Create
        /// <summary>
        ///     Submission of a SimpleHTMLPage from the UI
        /// </summary>
        /// <param name="obj">The new object to insert into the database</param>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        [HttpPost]
        public ActionResult Create(SimpleHTMLPage obj, LoggedInUser currentUser)
        {
            this.log.Info("Create [POST]", "Start of function");
            if (obj.Id == 0)
                ModelState["SimpleHTMLPageId"].Errors.Clear();
                
            this.BeforeValidate(obj);
            if (ModelState.IsValid) 
            {
                this.BeforeCreate(obj);
                work.SimpleHTMLPageRepository.InsertOrUpdate(obj, currentUser.User);
                work.Save();
        ...
        }  // POST: /Admin/SimpleHTMLPages/Create
        #endregion
        #region Section 'Actions - Edit'
        /// <summary>
        ///     View to edit an existing SimpleHTMLPage record in the system
        /// </summary>
        ...
        public ActionResult Edit(int id, LoggedInUser currentUser)
        {
            ...
            ViewResult result = View(work.SimpleHTMLPageRepository.Find(id));
            this.log.Info("Edit", "View created and returning");
            return result;
        }  // GET: /Admin/SimpleHTMLPages/Edit/{id}
        /// <summary>
        ...
        public ActionResult Edit(SimpleHTMLPage obj, LoggedInUser currentUser)
        {
            ...
            if (ModelState.IsValid) 
            {
                ...
                work.SimpleHTMLPageRepository.InsertOrUpdate(obj, currentUser.User);
                work.Save();
                obj = work.SimpleHTMLPageRepository.Find(obj.Id); //need to rehydrate the FKs
                this.AfterEdit(obj);
        ...
        }  // POST: /Admin/SimpleHTMLPages/Edit/{id}
        #endregion
        ...
        public ActionResult Delete(int id, LoggedInUser currentUser)
        {
            ...
            return result;
        }  // GET: /Admin/SimpleHTMLPages/Delete/5
        /// <summary>
        ...
        public ActionResult DeleteConfirmed(int id, LoggedInUser currentUser)
        {
            ...
            work.SimpleHTMLPageRepository.Delete(id);
            work.Save();
            this.AfterDelete(id);
            this.log.Info("Delete [POST]", "Object has been deleted");
            return RedirectToAction("Index");
        }  // POST: /Admin/SimpleHTMLPages/Delete/{id}
        #endregion
        #region Section 'Actions - Inline'
        /// <summary>
        ///     Retrieve view to create/edit an existing SimpleHTMLPage record in the system
        /// </summary>
        /// <param name="id">The id of the record to edit</param>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        public ActionResult QueryItem(int id, LoggedInUser currentUser)
        {
            ...
            SimpleHTMLPage obj = null;
            if (id != 0)
                obj = work.SimpleHTMLPageRepository.Find(id);

            ViewResult result = View("_CreateOrEdit", obj);
            this.log.Info("QueryItem", "View created and returning");
            return result;
        }  // GET: /Admin/SimpleHTMLPages/QueryItem/{id}
        /// <summary>
        ///     Submission of the editing model back from the UI
        /// </summary>
        /// <param name="obj">The edited model</param>
        ...
        /// <returns></returns>
        [HttpPost]
        public MvcHtmlString InsertOrUpdate(SimpleHTMLPage obj, LoggedInUser currentUser)
        {
            this.log.Info("Edit [POST]", "Start of function");
            if (obj.Id == 0)
                ModelState["SimpleHTMLPageId"].Errors.Clear();
        ...
        {
            this.log.Info("Delete", "Start of function");
            ViewResult result = View("_Display", work.SimpleHTMLPageRepository.Find(id));
            this.log.Info("Delete", "View created and returning");
            return result;
