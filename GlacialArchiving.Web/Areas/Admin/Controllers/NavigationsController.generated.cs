...
{   
    /// <summary>
    ///     The definition of NavigationsController
    /// </summary>
    public partial class NavigationsController : SecureController
    {
        /// <summary>
        ///     Default constructor for NavigationsController
        /// </summary>
        ...
        partial void BeforeValidate(Navigation obj);
        partial void BeforeCreate(Navigation obj);
        partial void AfterCreate(Navigation obj);
        partial void BeforeEdit(Navigation oldObj, Navigation obj);
        partial void AfterEdit(Navigation obj);
        ...
        /// <summary>
        ///     Sends the user to the listing page for Navigations
        /// </summary>
        ...
        public ActionResult Index(LoggedInUser currentUser)
        {
            ...
            ViewResult result = View(work.NavigationRepository.AllIncluding(obj => obj.NavItems));
        ...
        /// <summary>
        ///     View to create a new Navigation in the system
        /// </summary>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        public ActionResult Create(LoggedInUser currentUser)
        {
            ...
            return result;
        }   // GET: /Admin/Navigations/Create
        /// <summary>
        ///     Submission of a Navigation from the UI
        /// </summary>
        /// <param name="obj">The new object to insert into the database</param>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        [HttpPost]
        public ActionResult Create(Navigation obj, LoggedInUser currentUser)
        {
            this.log.Info("Create [POST]", "Start of function");
            if (obj.Id == 0)
                ModelState["NavigationId"].Errors.Clear();
                
            this.BeforeValidate(obj);
            if (ModelState.IsValid) 
            {
                this.BeforeCreate(obj);
                work.NavigationRepository.InsertOrUpdate(obj, currentUser.User);
                work.Save();
        ...
        }  // POST: /Admin/Navigations/Create
        #endregion
        #region Section 'Actions - Edit'
        /// <summary>
        ///     View to edit an existing Navigation record in the system
        /// </summary>
        ...
        public ActionResult Edit(int id, LoggedInUser currentUser)
        {
            ...
            ViewResult result = View(work.NavigationRepository.Find(id));
            this.log.Info("Edit", "View created and returning");
            return result;
        }  // GET: /Admin/Navigations/Edit/{id}
        /// <summary>
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Edit(Navigation obj, LoggedInUser currentUser)
        {
            ...
            if (ModelState.IsValid) 
            {
                Navigation oldObj = work.NavigationRepository.Find(obj.Id);
                obj.SyncExcludedFields(oldObj);
            
                this.BeforeEdit(oldObj, obj);
                work.NavigationRepository.InsertOrUpdate(obj, currentUser.User);
                work.Save();
                obj = work.NavigationRepository.Find(obj.Id); //need to rehydrate the FKs
                this.AfterEdit(obj);
        ...
        }  // POST: /Admin/Navigations/Edit/{id}
        #endregion
        ...
        public ActionResult Delete(int id, LoggedInUser currentUser)
        {
            ...
            return result;
        }  // GET: /Admin/Navigations/Delete/5
        /// <summary>
        ...
        }  // POST: /Admin/Navigations/Delete/{id}
        #endregion
        #region Section 'Actions - Inline'
        /// <summary>
        ///     Retrieve view to create/edit an existing Navigation record in the system
        /// </summary>
        /// <param name="id">The id of the record to edit</param>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        ...
        /// <returns></returns>
        [HttpPost]
        public MvcHtmlString InsertOrUpdate(Navigation obj, LoggedInUser currentUser)
        {
            this.log.Info("Edit [POST]", "Start of function");
            if (obj.Id == 0)
                ModelState["NavigationId"].Errors.Clear();
        ...
        {
            this.log.Info("Delete", "Start of function");
            ViewResult result = View("_Display", work.NavigationRepository.Find(id));
            this.log.Info("Delete", "View created and returning");
            return result;
