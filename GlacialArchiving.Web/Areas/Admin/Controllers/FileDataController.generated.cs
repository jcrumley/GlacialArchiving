...
{   
    /// <summary>
    ///     The definition of FileDataController
    /// </summary>
    public partial class FileDataController : SecureController
    {
        /// <summary>
        ///     Default constructor for FileDataController
        /// </summary>
        ...
        partial void BeforeValidate(FileData obj);
        partial void BeforeCreate(FileData obj);
        partial void AfterCreate(FileData obj);
        partial void BeforeEdit(FileData oldObj, FileData obj);
        partial void AfterEdit(FileData obj);
        ...
        /// <summary>
        ///     Sends the user to the listing page for FileData
        /// </summary>
        ...
        public ActionResult Index(LoggedInUser currentUser)
        {
            ...
            ViewResult result = View(work.FileDataRepository.AllIncluding());
        ...
        /// <summary>
        ///     View to create a new FileData in the system
        /// </summary>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        public ActionResult Create(LoggedInUser currentUser)
        {
            ...
            return result;
        }   // GET: /Admin/FileData/Create
        /// <summary>
        ///     Submission of a FileData from the UI
        /// </summary>
        /// <param name="obj">The new object to insert into the database</param>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        [HttpPost]
        public ActionResult Create(FileData obj, LoggedInUser currentUser)
        {
            this.log.Info("Create [POST]", "Start of function");
            if (obj.Id == 0)
                ModelState["FileDataId"].Errors.Clear();
                
            this.BeforeValidate(obj);
            if (ModelState.IsValid) 
            {
                this.BeforeCreate(obj);
                work.FileDataRepository.InsertOrUpdate(obj, currentUser.User);
                work.Save();
        ...
        }  // POST: /Admin/FileData/Create
        #endregion
        #region Section 'Actions - Edit'
        /// <summary>
        ///     View to edit an existing FileData record in the system
        /// </summary>
        ...
        public ActionResult Edit(int id, LoggedInUser currentUser)
        {
            ...
            ViewResult result = View(work.FileDataRepository.Find(id));
            this.log.Info("Edit", "View created and returning");
            return result;
        }  // GET: /Admin/FileData/Edit/{id}
        /// <summary>
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Edit(FileData obj, LoggedInUser currentUser)
        {
            ...
            if (ModelState.IsValid) 
            {
                FileData oldObj = work.FileDataRepository.Find(obj.Id);
                obj.SyncExcludedFields(oldObj);
            
                this.BeforeEdit(oldObj, obj);
                work.FileDataRepository.InsertOrUpdate(obj, currentUser.User);
                work.Save();
                obj = work.FileDataRepository.Find(obj.Id); //need to rehydrate the FKs
                this.AfterEdit(obj);
        ...
        public ActionResult DeleteConfirmed(int id, LoggedInUser currentUser)
        {
            ...
            work.FileDataRepository.Delete(id);
            work.Save();
            this.AfterDelete(id);
            this.log.Info("Delete [POST]", "Object has been deleted");
            return RedirectToAction("Index");
        }  // POST: /Admin/FileData/Delete/{id}
        #endregion
        #region Section 'Actions - Inline'
        /// <summary>
        ///     Retrieve view to create/edit an existing FileData record in the system
        /// </summary>
        /// <param name="id">The id of the record to edit</param>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        ...
        /// <returns></returns>
        [HttpPost]
        public MvcHtmlString InsertOrUpdate(FileData obj, LoggedInUser currentUser)
        {
            this.log.Info("Edit [POST]", "Start of function");
            if (obj.Id == 0)
                ModelState["FileDataId"].Errors.Clear();
        ...
        {
            this.log.Info("Delete", "Start of function");
            ViewResult result = View("_Display", work.FileDataRepository.Find(id));
            this.log.Info("Delete", "View created and returning");
            return result;
