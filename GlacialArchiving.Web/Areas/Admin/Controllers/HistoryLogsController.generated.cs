...
{   
    /// <summary>
    ///     The definition of HistoryLogsController
    /// </summary>
    public partial class HistoryLogsController : SecureController
    {
        /// <summary>
        ///     Default constructor for HistoryLogsController
        /// </summary>
        ...
        partial void BeforeValidate(HistoryLog obj);
        partial void BeforeCreate(HistoryLog obj);
        partial void AfterCreate(HistoryLog obj);
        partial void BeforeEdit(HistoryLog oldObj, HistoryLog obj);
        partial void AfterEdit(HistoryLog obj);
        ...
        /// <summary>
        ///     Sends the user to the listing page for HistoryLogs
        /// </summary>
        ...
        public ActionResult Index(LoggedInUser currentUser)
        {
            ...
            ViewResult result = View(work.HistoryLogRepository.AllIncluding(obj => obj.CreatedBy, obj => obj.ModifiedBy));
            this.log.Info("Index", "View created and returning");
            return result;
        }   // GET: /Admin/HistoryLogs/
        #endregion
        #region Section 'Actions - Create'
        /// <summary>
        ///     View to create a new HistoryLog in the system
        /// </summary>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        public ActionResult Create(LoggedInUser currentUser)
        {
            ...
            return result;
        }   // GET: /Admin/HistoryLogs/Create
        /// <summary>
        ///     Submission of a HistoryLog from the UI
        /// </summary>
        /// <param name="obj">The new object to insert into the database</param>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        [HttpPost]
        public ActionResult Create(HistoryLog obj, LoggedInUser currentUser)
        {
            this.log.Info("Create [POST]", "Start of function");
            if (obj.Id == 0)
                ModelState["HistoryLogId"].Errors.Clear();
                
            this.BeforeValidate(obj);
            if (ModelState.IsValid) 
            {
                this.BeforeCreate(obj);
                work.HistoryLogRepository.InsertOrUpdate(obj, currentUser.User);
                work.Save();
        ...
        }  // POST: /Admin/HistoryLogs/Create
        #endregion
        #region Section 'Actions - Edit'
        /// <summary>
        ///     View to edit an existing HistoryLog record in the system
        /// </summary>
        ...
        public ActionResult Edit(int id, LoggedInUser currentUser)
        {
            ...
            ViewResult result = View(work.HistoryLogRepository.Find(id));
            this.log.Info("Edit", "View created and returning");
            return result;
        }  // GET: /Admin/HistoryLogs/Edit/{id}
        /// <summary>
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Edit(HistoryLog obj, LoggedInUser currentUser)
        {
            ...
            if (ModelState.IsValid) 
            {
                HistoryLog oldObj = work.HistoryLogRepository.Find(obj.Id);
                obj.SyncExcludedFields(oldObj);
            
                this.BeforeEdit(oldObj, obj);
                work.HistoryLogRepository.InsertOrUpdate(obj, currentUser.User);
                work.Save();
                obj = work.HistoryLogRepository.Find(obj.Id); //need to rehydrate the FKs
                this.AfterEdit(obj);
        ...
        }  // POST: /Admin/HistoryLogs/Edit/{id}
        #endregion
        ...
        public ActionResult Delete(int id, LoggedInUser currentUser)
        {
            ...
            return result;
        }  // GET: /Admin/HistoryLogs/Delete/5
        /// <summary>
        ...
        }  // POST: /Admin/HistoryLogs/Delete/{id}
        #endregion
        #region Section 'Actions - Inline'
        /// <summary>
        ///     Retrieve view to create/edit an existing HistoryLog record in the system
        /// </summary>
        /// <param name="id">The id of the record to edit</param>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        ...
        /// <returns></returns>
        [HttpPost]
        public MvcHtmlString InsertOrUpdate(HistoryLog obj, LoggedInUser currentUser)
        {
            this.log.Info("Edit [POST]", "Start of function");
            if (obj.Id == 0)
                ModelState["HistoryLogId"].Errors.Clear();
        ...
        {
            this.log.Info("Delete", "Start of function");
            ViewResult result = View("_Display", work.HistoryLogRepository.Find(id));
            this.log.Info("Delete", "View created and returning");
            return result;
