...
{   
    /// <summary>
    ///     The definition of SettingsController
    /// </summary>
    public partial class SettingsController : SecureController
    {
        /// <summary>
        ...
        partial void BeforeValidate(Setting obj);
        partial void BeforeCreate(Setting obj);
        partial void AfterCreate(Setting obj);
        partial void BeforeEdit(Setting oldObj, Setting obj);
        partial void AfterEdit(Setting obj);
        ...
        /// <summary>
        ///     Sends the user to the listing page for Settings
        /// </summary>
        ...
        public ActionResult Index(LoggedInUser currentUser)
        {
            ...
            ViewResult result = View(work.SettingRepository.AllIncluding());
        ...
        /// <summary>
        ///     View to create a new Setting in the system
        /// </summary>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        ...
        /// <summary>
        ///     Submission of a Setting from the UI
        /// </summary>
        /// <param name="obj">The new object to insert into the database</param>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        [HttpPost]
        public ActionResult Create(Setting obj, LoggedInUser currentUser)
        {
            this.log.Info("Create [POST]", "Start of function");
            if (obj.Id == 0)
                ModelState["SettingId"].Errors.Clear();
                
            this.BeforeValidate(obj);
            if (ModelState.IsValid) 
            {
                this.BeforeCreate(obj);
                work.SettingRepository.InsertOrUpdate(obj, currentUser.User);
                work.Save();
        ...
        /// <summary>
        ///     View to edit an existing Setting record in the system
        /// </summary>
        ...
        public ActionResult Edit(int id, LoggedInUser currentUser)
        {
            ...
            ViewResult result = View(work.SettingRepository.Find(id));
            this.log.Info("Edit", "View created and returning");
            return result;
        }  // GET: /Admin/Settings/Edit/{id}
        /// <summary>
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Edit(Setting obj, LoggedInUser currentUser)
        {
            ...
            if (ModelState.IsValid) 
            {
                Setting oldObj = work.SettingRepository.Find(obj.Id);
                obj.SyncExcludedFields(oldObj);
            
                this.BeforeEdit(oldObj, obj);
                work.SettingRepository.InsertOrUpdate(obj, currentUser.User);
                work.Save();
                obj = work.SettingRepository.Find(obj.Id); //need to rehydrate the FKs
                this.AfterEdit(obj);
        ...
        public ActionResult DeleteConfirmed(int id, LoggedInUser currentUser)
        {
            ...
            work.SettingRepository.Delete(id);
            work.Save();
            this.AfterDelete(id);
        ...
        /// <summary>
        ///     Retrieve view to create/edit an existing Setting record in the system
        /// </summary>
        /// <param name="id">The id of the record to edit</param>
        /// <param name="currentUser">The current logged in user</param>
        /// <returns></returns>
        ...
        /// <returns></returns>
        [HttpPost]
        public MvcHtmlString InsertOrUpdate(Setting obj, LoggedInUser currentUser)
        {
            this.log.Info("Edit [POST]", "Start of function");
            if (obj.Id == 0)
                ModelState["SettingId"].Errors.Clear();
        ...
        {
            this.log.Info("Delete", "Start of function");
            ViewResult result = View("_Display", work.SettingRepository.Find(id));
            this.log.Info("Delete", "View created and returning");
            return result;
