...
(function ($) {
    $.SmartMessageBox = function (settings, callback) {
        ...
        if (isIE8orlower() == 0) {
            ...
            audioElement.setAttribute('src', '/content/SmartAdmin/sound/messagebox.mp3');
            $.get();
        ...
        if (settings.sound === true) {
            if (isIE8orlower() == 0) {
                ...
                if (navigator.userAgent.match('Firefox/'))
                    audioElement.setAttribute('src', '/content/SmartAdmin/sound/bigbox.ogg');
                else
                    audioElement.setAttribute('src', '/content/SmartAdmin/sound/bigbox.mp3');
    ...
    $.smallBox = function (settings, callback) {
        ...
        if (settings.sound === true) {
            if (isIE8orlower() == 0) {
                ...
                if (navigator.userAgent.match('Firefox/'))
                    audioElement.setAttribute('src', '/content/SmartAdmin/sound/smallbox.ogg');
                else
                    audioElement.setAttribute('src', '/content/SmartAdmin/sound/smallbox.mp3');
